package com.bisbiai.app.ui.navigation.components
...
fun CustomNavigationBar(
    ...
    val captionBarBottomPadding by rememberUpdatedState(
        WindowInsets.captionBar.only(WindowInsetsSides.Bottom).asPaddingValues()
                    ...
                    modifier = Modifier
                        ...
                        .height(
                            WindowInsets.navigationBars.asPaddingValues()
                                .calculateBottomPadding() + animatedCaptionBarHeight
                        )
